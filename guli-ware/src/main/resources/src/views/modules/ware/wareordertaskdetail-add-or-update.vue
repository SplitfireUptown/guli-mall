<template>
  <el-dialog
    ...
    <el-form-item label="1-锁定 2-解锁 3-扣减" prop="lockStatus">
      <el-input v-model="dataForm.lockStatus" placeholder="1-锁定 2-解锁 3-扣减"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          lockStatus: [
            { required: true, message: '1-锁定 2-解锁 3-扣减不能为空', trigger: 'blur' }
          ]
        }
      }
    },
