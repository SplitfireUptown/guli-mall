package com.uptown.guli.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.uptown.guli.member.feign.CouponFeignService;
...
import com.uptown.guli.member.service.MemberService;
...
public class MemberController {
    ...
    public R test() {
        ...
        R r = couponFeignService.memberCippon();
